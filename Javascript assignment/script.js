...
const displayDetails = (userData) => {
  ...
  : (greetMessage.innerHTML = `<b>Good Night ${userData.first_name} !</b>`);
  ...
  document.getElementById("social-insaurance-number").innerHTML = userData.social_insurance_number;
  document.getElementById("dob").innerHTML = userData.date_of_birth;
  document.getElementById("employment-title").innerHTML = userData.employment.title;
  ...
  document.getElementById("credit-card").innerHTML = userData.credit_card.cc_number;
  document.getElementById("subscription-plan").innerHTML = userData.subscription.plan;
